		...
		<div class="row mt2">
			<div class="col-md-10 col-md-offset-1 col-sm-8 col-sm-offset-2 centered">
				...
				<ul class="col-md-12 mt2 white">
					<li><a class="ml1 underline white">Brown IE + MBA Program Workshops</a></li>
					<li><a class="ml1 underline white">Creative Mind Sponsored Projects</a></li>
					<li><a class="ml1 underline white">Pick-me-up Projects</a></li>
					<li><a class="ml1 underline white">Neuroscience Research</a></li>
					<li><a class="ml1 underline white">Better World By Design</a></li>
				</ul>
			</div>
		</div>
	</div>
